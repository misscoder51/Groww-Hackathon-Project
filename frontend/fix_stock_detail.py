    ...
    <div className="max-w-4xl mx-auto w-full px-4 sm:px-8 py-8 space-y-8">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="text-right">
          ...
          <div className={ + '' + 	ext-lg font-semibold tracking-tight  + '' + }>
        ...
        <div className="bg-gray-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700/50 p-6 rounded-xl shadow-sm mt-8">
          ...
          <div className="flex items-center gap-6 text-sm">
            <div>
              ...
              <span className={ + '' + ont-bold  + '' + }>{formatPercent(data.context.delta_stock)}</span>
            </div>
            <div>
...
with open('src/components/stocks/StockDetailView.tsx', 'w', encoding='utf-8') as f:
    f.write(content)
